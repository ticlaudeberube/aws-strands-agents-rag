...
def main():
    ...
    print("   ✓ MilvusResponseCache initialized")
    ...
    try:
        ...
        if "response_cache" in collections:
            print("   ✓ response_cache collection exists")
        else:
            print("   ✗ response_cache collection NOT found")
    ...
    try:
        ...
        if result:
            ...
            print("   ✗ Cache MISS - search_cache returned None")
    except Exception as e:
    ...
    try:
        ...
        if result2:
            print("   ✓ Cache HIT for similar question!")
            print(f"     Similarity: {result2.get('similarity', 'N/A'):.1%}")
        else:
            print("   ✗ Cache MISS for similar question")
    except Exception as e:
        print(f"   ✗ Error: {e}")
    ...
    try:
        ...
        vector_db.client.load_collection(
            collection_name="response_cache", db_name=settings.milvus_db_name
        )
