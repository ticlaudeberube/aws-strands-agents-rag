...
def verify_collection_config():
    ...
    try:
        ...
        print(f"   Make sure Milvus is running: cd docker && docker-compose up -d\n")
        return False
    ...
    try:
        ...
        if not collections:
            ...
            for coll in collections:
                is_configured = " ← CONFIGURED IN .ENV" if coll == settings.ollama_collection_name else ""
    ...
    if configured_exists:
        ...
        print(f"   python document-loaders/load_milvus_docs_ollama.py\n")
        return False
