...
class TestHealthCheckEndpoint:
    ...
    def test_health_includes_service_endpoints(self):
        ...
        health = {"status": "ok", "ollama": "http://localhost:11434", "milvus": "localhost:19530"}
...
class TestResponseWithSources:
    ...
    def test_source_has_required_fields(self):
        ...
        source = {
            "id": "doc-1",
            "text": "Document text",
            "metadata": {"source": "knowledge_base", "collection": "milvus_docs"},
        }
...
class TestCacheEndpoint:
    ...
    def test_cache_stats_response_structure(self):
        ...
        cache_stats = {
            "embedding_cache": {"size": 100, "hits": 50, "misses": 25},
            "response_cache": {"size": 20, "hits": 10, "misses": 5},
        }
...
class TestErrorHandling:
    ...
    def test_error_response_has_message(self):
        ...
        error_response = {"error": {"message": "Invalid request", "code": "invalid_request"}}
    ...
    def test_missing_field_error_format(self):
        ...
        error = {"error": {"message": "Missing required field: messages", "code": "missing_field"}}

        assert "messages" in error["error"]["message"].lower()

    def test_invalid_model_error_format(self):
        """Verify invalid model error format."""
        error = {"error": {"message": "Invalid model: gpt-5", "code": "invalid_model"}}
...
class TestAPIContractStability:
    ...
    def test_openai_compatibility_model_field(self):
        ...
        request = {"model": "rag-agent", "messages": []}
